...
from escola import cadastrar_escola, listar_escolas, alterar_escola, excluir_escola
from turma import cadastrar_turma, listar_turmas, alterar_turma, excluir_turma
from aluno import cadastrar_aluno, listar_alunos, alterar_aluno, excluir_aluno
